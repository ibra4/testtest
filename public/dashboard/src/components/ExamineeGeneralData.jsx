...
function ExamineeGeneralData({ examinee, center, examiner, showNotes = true }) {
    return (
        <Row>
            ...
            <LabelValueCol label={'Examiner'} value={examiner && examiner.name} md={3} />
            <LabelValueCol label={'Center Name'} value={center && center.name} md={3} />
            ...
            {examinee?.school && <LabelValueCol label={'School - Workplace'} value={examinee.school} md={3} />}
            {examinee?.grade && <LabelValueCol label={'Grade'} value={examinee.grade} md={3} />}
