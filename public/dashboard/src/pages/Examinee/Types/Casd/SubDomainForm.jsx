                                        ...
                                        <Row key={index}>
                                            <Col xs={2} className="text-center">
                                                <CheckboxField
                                                    onChange={(evt) =>
                                                        setFieldValue(
                                                            `questions.${getQuestionIndex(questionField.id)}.checked`,
                                                            evt.target.checked
                                                        )
                                                    }
                                                    ...
                                                    value={
                                                        values.questions[getQuestionIndex(questionField.id)]?.checked
                                                    }
                                                    onBlur={handleBlur}
                                                    className="mb-3"
                                            ...
                                            <Col xs={10}>
                                                ...
                                                <p dangerouslySetInnerHTML={{ __html: questionField.description }} />
                                            </Col>
                                            <hr />
                                        </Row>
                                    ))
